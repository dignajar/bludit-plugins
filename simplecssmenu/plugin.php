...
class pluginSimpleCSSMenu extends Plugin {
    ...
    // Path plugin.
    	...
    	return '<link rel="stylesheet" href="' . $pluginPath . 'style.css">';
    }
	...
	public function siteSidebar()
	{
		...
		$html .= '<nav id="menu_box">';
		$html .= '<ul class="menu">';

		// Show home link ?
		if($this->getDbField('homeLink')) {
			$html .= '<li>';
			$html .= '<a href="'.$Site->homeLink().'">'.$Language->get('Home').'</a>';
			$html .= '</li>';
		}
